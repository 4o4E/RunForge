...
import { streamdownPlugins, streamdownRehypePlugins, useThemedMermaid } from './streamdownConfig';
    ...
    <MarkdownRenderOptionsProvider value={{ streaming }}>
      <Streamdown
        className={cn(
          ...
          '[&>*]:max-w-none [&_li]:max-w-none [&_p]:max-w-none [&_ul]:max-w-none [&_ol]:max-w-none',
